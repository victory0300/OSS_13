...
저희는 Chat GPT의 기능의 성격에 따라 정보전달기능, 창의적인 기능, 정보 분석 기능, 기타 기능 총 네가지로 분류했습니다. 
...
저희는 Chat GPT의 정보전달기능, 창의적 기능, 정보 분석 기능, 그 외 기타 여러기능까지 분석해 보았습니다. Chat GPT는 사용자의 요구에 맞는 결과물을 제시하기 위해
